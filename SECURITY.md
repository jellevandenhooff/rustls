...
- Infinite loops, 
- Reachable loops with inappropriate and attacker-controlled complexity,
- Reachable panics,
- Authentication bypass,
- Protocol downgrade,
- Memory exhaustion or excessive memory consumption.
...
- We have [studied and explain](https://rustls.dev/docs/manual/_01_impl_vulnerabilities/index.html#a-review-of-tls-implementation-vulnerabilities)
  issues encountered in other TLS implementations and discuss further mitigations there.
- We implement the TLS 1.3 downgrade sentinal (a [standard and required protocol feature](https://datatracker.ietf.org/doc/html/rfc8446#section-4.1.3)
